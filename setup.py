...
setup(
    ...
    entry_points={
        ...
        'jacquard.commands': (
            ...
            'user-show = jacquard.users.commands:Show',
            ...
            'experiment-load = jacquard.experiments.commands:Load',
            'experiment-list = jacquard.experiments.commands:ListExperiments',
            'user-list = jacquard.directory.commands:ListUsers',
